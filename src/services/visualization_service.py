...
class VisualizationService:
    ...
    def get_player_image():
        return pygame.image.load(ASSETS_DIR / "luffy_img.png").convert_alpha()
    ...
    def get_background_image():
        return pygame.image.load(ASSETS_DIR / "neon-red.jpg").convert_alpha()
    ...
    def get_holding_gift_image():
        return pygame.image.load(MENU_DIR / "holding_luffy.png").convert_alpha()
    ...
    def load_main_game_displays():
        pygame.display.set_caption("Don't Touch My Luffy")
    ...
    def draw_author_credits(screen):
        ...
        author_credits = credit_font.render("© Dr.Stone 2023", True, (255, 255, 255))
